      ...
      >
        ...
        <div className="mt-4">
          ...
          <p className="mt-2 text-sm text-gray-600 dark:text-gray-300">
            Are you sure you want to delete this product? If sales transactions or previous movements are linked, the product will be safely archived to protect accounting integrity.
          </p>
        </div>
        ...
        <div className="mt-6 flex items-center justify-end gap-3">
          ...
          <button
            ...
            disabled={isDeleting}
            className="inline-flex items-center gap-2 rounded-xl bg-red-600 px-4 py-2 text-sm font-semibold text-white shadow-xs transition hover:bg-red-700 disabled:opacity-50 dark:bg-red-500 dark:hover:bg-red-600"
          >
