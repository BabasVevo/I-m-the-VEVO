...
export const INITIAL_DEMO_SUPPLIERS: Supplier[] = [
  {
    ...
    name: 'Kilimanjaro Coffee Plantations Ltd',
    contact_person: 'David Mrosso',
    supplier_type: 'manufacturer',
    tax_number: 'TRA-109-882-311',
    website: 'https://kilimanjarocoffee.co.tz',
    phone: '+255 27 275 4321',
    alternative_phone: '+255 754 112 233',
    email: 'orders@kilimanjarocoffee.co.tz',
    address: 'Plot 45, Old Moshi Road',
    city: 'Moshi',
    country: 'Tanzania',
    payment_terms: 'net_30',
    credit_limit: 15000000,
    current_balance: 1800000,
    notes: 'Primary single-origin coffee supplier. Free delivery for orders over TZS 5,000,000.',
  ...
  },
  {
    id: 'supp-2',
    business_id: 'demo-biz-1',
    name: 'Zanzibar Spice Merchants Co.',
    contact_person: 'Fatma Al-Harthy',
    supplier_type: 'distributor',
    tax_number: 'TRA-204-551-900',
    website: 'https://zanzibarspices.co.tz',
    phone: '+255 24 223 9988',
    alternative_phone: '+255 777 445 566',
    email: 'supply@zanzibarspices.co.tz',
    address: 'Stone Town Wharf, St. 12',
    city: 'Zanzibar',
    country: 'Tanzania',
  ...
  },
  {
    ...
    website: 'https://apexretailtech.tz',
    phone: '+255 22 212 6700',
    alternative_phone: '+255 713 900 888',
    email: 'sales@apexretailtech.tz',
    address: 'Samora Avenue, City Center',
    city: 'Dar es Salaam',
    country: 'Tanzania',
    payment_terms: 'cod',
  ...
  },
  {
    id: 'supp-4',
    business_id: 'demo-biz-1',
    name: 'Tanzania Paper & Packaging Industries',
    contact_person: 'Grace Shirima',
    supplier_type: 'wholesaler',
    tax_number: 'TRA-409-112-887',
    website: 'https://tzpaperpack.com',
    phone: '+255 22 286 4400',
    alternative_phone: '+255 784 332 110',
    email: 'info@tzpaperpack.com',
  ...
  },
  {
    id: 'supp-5',
    business_id: 'demo-biz-1',
    name: 'Serengeti Dairy & Syrups Co.',
    contact_person: 'Peter Mwita',
    supplier_type: 'wholesaler',
    tax_number: 'TRA-551-778-992',
    website: null,
    phone: '+255 28 250 0980',
    alternative_phone: null,
    email: 'orders@serengetidairy.tz',
    address: 'Mwanza Road, Industrial Zone',
    city: 'Mwanza',
    country: 'Tanzania',
      ...
      const initial: SupplierNote[] = [
        {
          ...
          content: 'Negotiated 5% bulk volume discount on Kilimanjaro AAA grade beans for orders over 50kg.',
