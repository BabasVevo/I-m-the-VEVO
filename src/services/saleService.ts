  ...
  return [
    ...
    },
    {
      ...
      cashier: {
        ...
        business_id: 'demo-biz-1',
        branch_id: 'branch-downtown',
        full_name: 'Kelvin Moshi',
        phone: '+255 766 889 900',
        role_id: 'demo-role-cashier',
        is_active: true,
        created_at: yesterday1,
        updated_at: yesterday1,
...
// Export Sales To CSV
// ----------------------------------------------------
export function exportSalesToCsv(sales: Sale[], currency = 'TZS'): string {
  const headers = [
    'Receipt Number',
    'Date & Time',
    'Branch',
