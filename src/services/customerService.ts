...
export const INITIAL_DEMO_CUSTOMERS: Customer[] = [
  ...
  },
  {
    ...
    address: 'Boulevard du 1er Novembre',
    city: 'Bujumbura',
    country: 'Burundi',
  ...
  },
  {
    ...
    gender: 'female',
    customer_type: 'vip',
    notes: 'Premium specialty customer. Visits when in Bujumbura.',
    assigned_branch_id: 'branch-downtown',
    status: 'active',
  ...
  },
  {
    ...
    first_name: 'Amina',
    last_name: 'Salum',
    email: 'amina.salum@coastal.bi',
    phone: '+257 777 654 321',
  ...
  },
  {
    ...
    phone: '+257 768 119 922',
    address: 'Route de Gitega',
    city: 'Gitega',
    country: 'Burundi',
...
export const INITIAL_DEMO_ACTIVITY: CustomerActivity[] = [
  {
    ...
    customer_id: 'cust-1',
    activity_type: 'sale',
    description: 'Completed purchase of BIF 245,000 via Mobile Money (Receipt #REC-10024)',
  ...
  },
  {
    ...
    customer_id: 'cust-2',
    activity_type: 'sale',
    description: 'Completed purchase of BIF 1,450,000 on Corporate Credit (Receipt #REC-10019)',
  ...
  },
  {
    ...
    description: 'Processed refund of BIF 50,000 for damaged packaging (Return #RET-004)',
...
export async function recordCustomerSale(
  ...
  await logCustomerActivity(
    ...
    businessId,
    'sale',
    `Completed sale of BIF ${totalAmount.toLocaleString()} (Receipt #${receiptNumber})`,
    authorId,
...
export async function recordCustomerRefund(
  ...
  await logCustomerActivity(
    ...
    businessId,
    'refund',
    `Processed refund of BIF ${refundAmount.toLocaleString()} (Return #${returnNumber})`,
    authorId,
...
export const DEFAULT_SYSTEM_SEGMENTS: CustomerSegment[] = [
  ...
  },
  {
    ...
    business_id: 'demo-biz-1',
    name: 'VIP Customers',
    description: 'Lifetime spending exceeds BIF 1,500,000',
    segment_type: 'system',
    color: 'purple',
    is_active: true,
    conditions_logic: 'AND',
  ...
  },
  {
    ...
    description: 'Lifetime spending exceeds BIF 3,000,000',
    segment_type: 'system',
    color: 'amber',
    is_active: true,
    conditions_logic: 'AND',
...
export async function fetchCrmDashboardStats(businessId: string): Promise<{
  ...
  const branchDistribution = [
    ...
    { name: 'Rohero Mall', customers: Math.floor(total * 0.25), revenue: Math.round(totalSpending * 0.2) },
  ];
