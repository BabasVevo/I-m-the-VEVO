...
export const INITIAL_DEMO_BRANCHES: Branch[] = [
  ...
  },
  {
    id: 'branch-arusha',
    business_id: 'demo-biz-1',
    name: 'Muyinga North Branch',
    address: 'Route de Ngozi, Muyinga, Burundi',
    phone: '+257 22 27 5230',
    email: 'muyinga@babaspos.bi',
    manager_id: null,
    is_active: true,
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  ...
  return [
    {
      ...
      product: {
        ...
        description: 'Burundi single-origin whole bean coffee',
        unit: 'kg',
        cost_price: 18000,
        selling_price: 32000,
        min_stock_level: 10,
    ...
    },
    {
      ...
      product: {
        ...
        description: 'Bujumbura spiced black tea blend',
        unit: 'box',
        cost_price: 9500,
        selling_price: 18500,
        min_stock_level: 8,
  ...
  return [
    ...
    },
    {
      ...
      customer: {
        ...
        business_id: 'demo-biz-1',
        name: 'Baraka Mkapa',
        email: 'b.mkapa@serengeti.bi',
        phone: '+257 784 990 011',
    ...
    },
    {
      ...
      customer: {
        ...
        phone: '+257 767 444 888',
        address: 'Centre-Ville, Gitega, Burundi',
    ...
    },
    {
      ...
      customer: {
        ...
        email: 'accounts@victoriacargo.bi',
        phone: '+257 713 555 666',
        address: 'Zone Portuaire, Bujumbura, Burundi',
